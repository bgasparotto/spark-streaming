...
//        val repartitionedRDD = rdd.cache() // Would save multiple files depending on the input
        // And print out a directory with the results.
        repartitionedRDD.saveAsTextFile("spark_tmp/data/Tweets_" + time.milliseconds.toString)
